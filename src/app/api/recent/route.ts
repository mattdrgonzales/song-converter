...
export async function GET(): Promise<Response> {
  ...
  try {
    ...
    const url = `https://api.airtable.com/v0/${baseId}/Conversions?maxRecords=3&sort%5B0%5D%5Bfield%5D=last_searched&sort%5B0%5D%5Bdirection%5D=desc&fields%5B%5D=song_title&fields%5B%5D=artist&fields%5B%5D=spotify_link&fields%5B%5D=apple_music_link&fields%5B%5D=youtube_link`;
